        ...
        >
            ...
            <div className="max-w-5xl mx-auto sm:px-6 lg:px-8 py-12 flex flex-col">
                <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <form onSubmit={handleSubmit} className='flex flex-col mx-auto max-w-3xl p-12'>
                        ...
                        <input className='w-full border-gray-300 rounded-md mt-1' type="text" name='price' id='price' />
                        <label className='text-gray-700 text-xl tracking-wide mt-8' htmlFor='image'>IMAGE</label>
                        <input className='mt-1' type="file" name='image' id='image' />
                        <label className='text-gray-700 text-xl tracking-wide mt-8' htmlFor='description'>DESCRIPTION</label>
                        <textarea className='w-full border-gray-300 rounded-md mt-1' name='description' id='description' rows='50'></textarea>
                        <button className=' bg-blue-500 max-w-min px-8 py-3 mt-8 mx-auto rounded-xl text-white text-xl tracking-wide'>SUBMIT</button>
                    </form>
                </div>
            </div>
